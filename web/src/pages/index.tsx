    ...
    <div className='max-w-[1124px] h-screen mx-auto gap-28 grid grid-cols-2 items-center'>
      <main>
        ...
        <div className='mt-10 flex items-center gap-2'>
          <Image src={usersAvatarExample} alt="Example of users in Bolão"/>
          <strong className='text-gray-100 text-xl'>
            <span className='text-ignite-500'>+ {props.userCount}</span> pessoas já usando
          </strong>
        </div>
        ...
        <div className='mt-10 pt-10 border-t border-gray-600 flex items-center justify-between text-gray-100'>
          <div className='flex items-center gap-6'>
            <Image src={checkImg} alt="Check circle"/>
